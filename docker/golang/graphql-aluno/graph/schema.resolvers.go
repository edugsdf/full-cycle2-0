...
import (
	...
	"github.com/edugsdf/full-cycle2-0/tree/main/docker/golang/graphql-aluno/graph/generated"
	"github.com/edugsdf/full-cycle2-0/tree/main/docker/golang/graphql-aluno/graph/model"
)
...
func (r *mutationResolver) CreateCourse(ctx context.Context, input model.NewCourse) (*model.Course, error) {
	...
	for _, v := range r.Categories {
		if v.ID == input.CategoryID {
			category = v
			// Talvez aqui poderia ter um break
			//break
		}
	}
...
func (r *mutationResolver) CreateNewChapter(ctx context.Context, input model.NewChapter) (*model.Chapter, error) {
